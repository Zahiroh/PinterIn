<?php include 'pembukadosen.php';?>
	...
	<table class="table table-bordered">
		...
		<tr>
			...
			<td width="2%" class="text-center">
				<?php if($d->STATUS_QUIZ==0) {?>
			<a href="../../Quiz/buatquisbaru/<?php echo "$d->COURSE_ID"; ?>"><button type="button" class="btn btn-success bg-success" style="color:white"><i class="material-icons">library_add</i></button></a>
			  <?PHP }else { ?>
					<a href="../../Quiz/loadperquiz/<?php echo "$d->COURSE_ID"; ?>"><button type="button" class="btn btn-success bg-info" style="color:white"><i class="material-icons">remove_red_eye</i></button></a>
					<a href="../../Quiz/editperquiz/<?php echo "$d->COURSE_ID"; ?>"><button type="button" class="btn btn-success bg-warning" style="color:white"><i class="material-icons">tune</i></button></a>
					<a href="../../Quiz/hapusperquiz/<?php echo "$d->COURSE_ID"; ?>"><button type="button" class="btn btn-success bg-secondary" style="color:white"><i class="material-icons">clear</i></button></a>
					<a href="../../Quiz/tesquiz/<?php echo "$d->COURSE_ID"; ?>"><button type="button" class="btn btn-success bg-danger" style="color:white"><i class="material-icons">poll</i></button></a>
			  <?PHP } ?>
			</td>
		</tr>
		<?php } ?>
