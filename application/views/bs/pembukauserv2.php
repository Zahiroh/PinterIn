                ...
                <div id="dw-s1" class="bmd-layout-drawer bg-faded">
                  ...
                  <ul class="list-group text-center" style="margin:auto;">
                        <div class="profile-user" style="padding-bottom:10px;">
                            <img src="../../../assets/user.jpg" alt="" class="border-lg rounded-circle" style="height:100px;width:100px;">
                            <p style="padding-top:5px;"><a href=""><strong><?php echo $_SESSION['nama'];?></strong></p><p><i class="material-icons">settings_applications</i></a></p>
                        </div>
