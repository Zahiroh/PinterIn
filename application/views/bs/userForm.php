                ...
                <div class="col-md-9 right">
                 ...
                 <div class="tab-content" id="myTabContent">
                                                      ...
                                                      <div class="row register-form">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <input name="NAMA_PROFILE"type="text" class="form-control" placeholder="Nama *" value="" />
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="ALAMAT_PROFILE" type="text" class="form-control" placeholder="Alamat *" value="" />
                                                            </div>
                                                            <div class="form-group">
                                                                <input name="EMAIL" type="email" maxlength="20" minlength="10" class="form-control" placeholder="E-mail *" value="" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <input name="USERNAME_SISWA" type="text" class="form-control" placeholder="Username *" value="" />
                                                            </div>
                                                            <div class="form-group">
                                                ...
                                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="profile-tab">
                                                    <form action="cari_user_siswa" method="post">
                                                            <div class="col-md-8">
                                                            <div class="form-group">
